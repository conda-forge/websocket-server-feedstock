About websocket-server-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/websocket-server-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/websocket-server-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add websocket-server
# for installing globally
pixi global install websocket-server
```
...
It is possible to list all of the versions of `websocket-server` available on your platform:
...
```
pixi search websocket-server --channel conda-forge
```
